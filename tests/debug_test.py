...
def main():
    ...
    try:
        ...
        print("✓ Data structure test skipped")
    except Exception as e:
    ...
    try:
        # Extract criteria
        print("\nExtracting criteria definitions...Skipped")
        ...
        print("\nRunning full criteria coverage test...Skipped")
        # test.test_criteria_coverage(sample_data, system_prompt)
        print("✓ Criteria coverage test skipped")
    except Exception as e:
